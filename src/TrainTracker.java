...
//
//    // 1. Unser HashSet für die Zug-IDs (JourneyRefs).
//    // Hier merken wir uns, WELCHE Züge gerade im Netz unterwegs sind.
//    private Set<TrainIdentifier> activeJourneyRefs = new HashSet<>();
//
//    // 2. Hier speichern wir die fertigen Train-Objekte, die später per REST/JSON ans Frontend gehen.
...
//
//                Set<TrainIdentifier> newlyFoundTrains = new HashSet<>();
//
//                // 5. XML parsen (Radar)
//                List<TrainIdentifier> trainsIdent = TriasXmlParser.parseSerResponse(responseXml);
//
//                newlyFoundTrains.addAll(trainsIdent);
//
//
//
